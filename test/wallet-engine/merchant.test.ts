...
import { DepixApiClient, type MerchantUpdateWireBody } from "../../src/wallet-engine/api/client.js";
import { MerchantNamespace, type MerchantUpdateFields } from "../../src/wallet-engine/merchant.js";
import { DepixApiError, MerchantError, isDepixSdkError } from "../../src/wallet-engine/errors.js";
