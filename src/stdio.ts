...
//
// One process, one server, 59 tools: the 26 gateway tools (a pure client of the
...
//   - both present: all 59 work.
// The catalog is ALWAYS 59 — MCP hosts snapshot tools/list at connect and
